...
public class CustomScratchView extends View {
    ...
    public interface OnScratchListener {
        void onScratch(CustomScratchView scratchCard, float visiblePercent);
    }

    public CustomScratchView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        resolveAttr(context, attrs);
    }

    public CustomScratchView(Context context, AttributeSet attrs) {
        super(context, attrs);
        resolveAttr(context, attrs);
    }
    ...
    private void resolveAttr(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CustomScratchView);
        mDrawable = typedArray.getDrawable(R.styleable.CustomScratchView_scratchDrawable);
        mScratchWidth = typedArray.getDimension(R.styleable.CustomScratchView_scratchWidth, Utils.dipToPx(context, 70));
        typedArray.recycle();
    }
